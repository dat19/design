...
## 正月休み課題 ゲームデザイン実習
- 課題内容
  - 前期に学んだゲームの企画の作成方法と、後期のこれまでに体験したこと、[ゲームプログラミングの課題](https://github.com/dat19/gp1/blob/master/README.md#%E6%AD%A3%E6%9C%88%E4%BC%91%E3%81%BF%E8%AA%B2%E9%A1%8C)の調査結果を元に、ゲームやサービスの企画提案書を作成して、プレゼンする
- 条件
...
- 今日の作業
  ...
  - [たんぽぽがプレイヤーに触れても発動するのと、発動後、水をかけると綿毛を出すのが止まるのを直す](https://trello.com/c/T8j6YzFR/) マエダ、ショウジ
    - +ステラの水まき
